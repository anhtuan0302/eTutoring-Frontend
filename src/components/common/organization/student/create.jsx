  ...
  return (
    <div>
      ...
      >
        <Button
          ...
          onClick={() => navigate(`${effectiveBasePath}/student`)}
        >
          Back to List
        </Button>
      </div>
      ...
      <Form form={form} layout="vertical" onFinish={onFinish}>
        ...
        <Form.Item>
          <Space>
            ...
            <Button onClick={() => navigate(`${effectiveBasePath}/student`)}>
              Cancel
            </Button>
          </Space>
        </Form.Item>
    ...
    >
      <div style={{ textAlign: 'center', marginBottom: 16 }}>
        ...
        <p>The invitation has been sent to the student's email address.</p>
...
export default CreatePendingStudent;
